 ...
 */
@Repository
public class AsstInfoTeacherDAOImpl implements AsstInfoTeacherDAO {

    @Resource
    private AsstInfoTeacherMapper asstInfoTeacherMapper;

    @Override
    public List<AsstInfoTeacherDO> list(AsstInfoTeacherQuery data) {
        if (data.getDataStatus() == null) {
            data.setDataStatus(DataStatusEnum.NORMAL.getValue());
        }
        return asstInfoTeacherMapper.list(data);
    }
    ...
    public int insertBatch(List<AsstInfoTeacherDO> list) {
        ...
        return asstInfoTeacherMapper.insertBatch(list);
    }
    ...
    public int updateBatch(List<AsstInfoTeacherDO> list) {
        ...
        return asstInfoTeacherMapper.updateBatch(list);
    }

    @Override
    public int removeBatch(List<Long> list) {
        return asstInfoTeacherMapper.removeBatch(list);
    }

    @Override
    public int deleteBatch(List<Long> list) {
        return asstInfoTeacherMapper.deleteBatch(list);
    }
